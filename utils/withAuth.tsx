...
const withAuth = (WrappedComponent) => {
  const availablesRoutes = {
    ...
    'BE:COMPANY': ['/proyecto', '/proyecto/details/[id]', '/empresa', '/hojas-de-vida', '/'],
    'BE:ADMIN': ['/proyecto', '/proyecto/nuevo', '/proyecto/edit/[id]', '/proyecto/details/[id]', '/usuario', '/hojas-de-vida', '/']
  }
  return (props) => {
