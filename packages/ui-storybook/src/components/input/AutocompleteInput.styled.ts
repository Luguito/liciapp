...
export const SuggestionsContainer = styled.div<{
    suggestionsBoxHeight: string | undefined;
}>`
    position: absolute;
    top: 35px;
    width: 100%;
...
export const SuggestionItem = styled.li<{ disableHighLighted: boolean }>`
    ...
    &:hover {
        background-color: ${props =>
            props.disableHighLighted ? ColorLiciBackgroundWhite : 'rgba(0, 0, 0, 0.04)'};
    }
`;
