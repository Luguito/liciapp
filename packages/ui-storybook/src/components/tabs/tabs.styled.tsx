...
export const TabHeader = styled.div<{ isSelected: boolean }>`
    width: auto;
    position: initial;
...
`;
export const LineSelector = styled.div<{ isSelected: boolean, index: number, }>`
    height: 20px;
    position: absolute;
    bottom: -8px;
...
export const RightBorderSeparator = styled.div<{ isSelected: boolean }>`
...
export const LeftBorderSeparator = styled.div<{ index: number, isSelected: boolean }>`
    background-color: white;
    width: 20px;
    height: 20%;
    position: absolute;
